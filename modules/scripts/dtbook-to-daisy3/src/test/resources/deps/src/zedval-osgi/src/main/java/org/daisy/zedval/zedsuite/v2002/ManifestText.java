...
/**
 * Performs package file manifest integrity check for text book types:
 * <dl>
 * <dt>opf_mnfOneDtbook</dt>
 * <dd>Manifest references at least one dtbook file</dd>
 * </dl>
 * 
 * @author James Pritchett
 */

public class ManifestText extends ZedCustomTest {

	/**
	 * Performs the manifest integrity tests on the package file for text book
	 * types
	 * 
	...
	public void performTest(ZedFile f) throws ZedCustomTestException {
		...
		// TEST: Manifest references at least one dtbook file
		if (p.getTextFiles() == null) {
		    super.addTestFailure("opf_mnfOneDtbook","Could not detect any text content files in manifest", null, null);
		}
